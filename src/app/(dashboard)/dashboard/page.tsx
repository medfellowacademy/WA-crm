  ...
  const loadAll = useCallback(() => {
    ...
    void loadMetrics(db)
      ...
      .catch((err) => {
        ...
        console.error('[dashboard] metrics failed:', msg)
      })
    ...
    void loadConversationsSeries(db, 30)
      ...
      .catch((err) => {
        const msg = err instanceof Error ? err.message : JSON.stringify(err) || String(err)
        console.error('[dashboard] series failed:', msg)
      })
    ...
    void loadPipelineDonut(db)
      ...
      .catch((err) => {
        const msg = err instanceof Error ? err.message : JSON.stringify(err) || String(err)
        console.error('[dashboard] pipeline failed:', msg)
      })
    ...
    void loadResponseTime(db)
      ...
      .catch((err) => {
        const msg = err instanceof Error ? err.message : JSON.stringify(err) || String(err)
        console.error('[dashboard] response time failed:', msg)
      })
